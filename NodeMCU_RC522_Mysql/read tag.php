...
<html>
	<head>
		...
		ul.topnav li a:hover:not(.active) {background-color: #009fe3;}
	...
	<body>
		<h2 align="center">RFID ENABLE PASSPORT VERIFICATION SYSTEM</h2>
		<ul class="topnav">
		...
		<h3 align="center" id="blink">Please Tag to Display ID or User Informations</h3>
		...
		<script>
			...
			function showUser(str) {
				if (str == "") {
					...
					xmlhttp.open("GET","read tag userdata.php?id="+str,true);
					xmlhttp.send();
				}
			}
